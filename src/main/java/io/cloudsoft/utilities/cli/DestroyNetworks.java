...
@Command(name = "deletenetworks", description = "Destroy all networks in the clouds matching a given prefix")
public class DestroyNetworks extends CloudCleanerCommand {
   ...
   private void destroyNetworks() throws Exception {
      ...
      for (String provider : providers) {
         new ProviderFactory().getProviderInstance(provider)
                 .deleteNetworks(projectName, prefix);
      }
   }
